...
import com.jsunwoo.gradechecker.dao.BridgeTCDao;
...
@Database(entities = {GradeScale.class, WorkWeightMark.class, Term.class, Course.class, TCBridge.class},version = 1)
public abstract class GradeCheckerDB extends RoomDatabase {
    ...
    public abstract BridgeTCDao btcdao();
}
